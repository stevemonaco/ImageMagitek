...
{
    public sealed class ColorConverterBgr12 : IColorConverter<ColorBgr12>
    {
        ...
        public ColorBgr12 ToForeignColor(ColorRgba32 nc)
        {
            byte r = (byte)MathF.Round(nc.r / (255f / 7f));
            byte g = (byte)MathF.Round(nc.g / (255f / 7f));
            byte b = (byte)MathF.Round(nc.b / (255f / 7f));

            return new ColorBgr12(r, g, b);
        }

        public ColorRgba32 ToNativeColor(ColorBgr12 fc)
        {
