...
public class StreamWriteExtensionTestCases
{
    ...
    public static IEnumerable<TestCaseData> WriteUnshiftedCases
    {
        get
        {
            yield return new TestCaseData(_singleArray.Clone(), new BitAddress(0, 0), 1,
                new byte[] { 0b00000000 }, new byte[] { 0b00011101 });
            yield return new TestCaseData(_singleArray.Clone(), new BitAddress(0, 2), 2,
                new byte[] { 0b00110000 }, new byte[] { 0b10111101 });
            yield return new TestCaseData(_singleArray.Clone(), new BitAddress(0, 2), 6,
                new byte[] { 0b00111110 }, new byte[] { 0b10111110 });

            yield return new TestCaseData(_largeArray.Clone(), new BitAddress(1, 3), 14,
                new byte[] { 0b00010101, 0b11010100, 0b00000000 }, new byte[] { 0b10110011, 0b11110101, 0b11010100, 0b01001100, 0b10000001 });

            yield return new TestCaseData(_largeArray.Clone(), new BitAddress(0, 1), 38,
            ...
            yield return new TestCaseData(_largeArray.Clone(), new BitAddress(0, 0), 40,
