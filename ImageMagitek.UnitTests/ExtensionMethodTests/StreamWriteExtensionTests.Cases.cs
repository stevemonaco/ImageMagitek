...
public partial class StreamWriteExtensionTests
{
    ...
    public static TheoryData<byte[], BitAddress, int, byte[], byte[]> WriteUnshiftedCases => new()
    {
        {
            (byte[])_singleArray.Clone(), new BitAddress(0, 0), 1, new byte[] { 0b00000000 }, new byte[] { 0b00011101 }
        },
        {
            (byte[])_singleArray.Clone(), new BitAddress(0, 2), 2, new byte[] { 0b00110000 }, new byte[] { 0b10111101 }
        },
        {
            (byte[])_singleArray.Clone(), new BitAddress(0, 2), 6, new byte[] { 0b00111110 }, new byte[] { 0b10111110 }
        },
        {
            (byte[])_largeArray.Clone(), new BitAddress(1, 3), 14,
                new byte[] { 0b00010101, 0b11010100, 0b00000000 }, new byte[] { 0b10110011, 0b11110101, 0b11010100, 0b01001100, 0b10000001 }
        },
        {
            (byte[])_largeArray.Clone(), new BitAddress(0, 1), 38,
        ...
        {
            (byte[])_largeArray.Clone(), new BitAddress(0, 0), 40,
        ...
        {
            (byte[])_singleArray.Clone(), new BitAddress(0, 0), 1, new byte[] { 0b00000010 }, new byte[] { 0b00011101 }
        },
        {
            (byte[])_largeArray.Clone(), new BitAddress(1, 3), 14,
    ...
    public static TheoryData<byte[], BitAddress, int, byte[], byte[]> WriteShiftedCases => new()
    {
        {
            (byte[])_singleArray.Clone(), new BitAddress(0, 0), 1, new byte[] { 0b00000000 }, new byte[] { 0b00011101 }
        },
        {
            (byte[])_singleArray.Clone(), new BitAddress(0, 2), 2, new byte[] { 0b11000000 }, new byte[] { 0b10111101 }
        },
        {
            (byte[])_singleArray.Clone(), new BitAddress(0, 2), 6, new byte[] { 0b11111000 }, new byte[] { 0b10111110 }
        },
        {
            (byte[])_largeArray.Clone(), new BitAddress(1, 3), 14,
